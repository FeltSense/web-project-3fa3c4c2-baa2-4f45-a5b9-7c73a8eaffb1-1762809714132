export default function Pricing() {
  ...
  <div className="max-w-7xl mx-auto">
    ...
    <div className="mt-12 md:mt-16 flex justify-center">
      <div className="w-full max-w-md bg-white rounded-2xl border-2 border-blue-600 shadow-xl p-8 md:p-10 lg:p-12 hover:shadow-2xl transition-shadow duration-300">
        {/* Badge */}
        ...
        {/* CTA Button */}
        <button 
          onClick={() => window.location.href = 'https://buy.stripe.com/test_cNicN778gcvQ2NZ3gV6Ri00?client_reference_id=3fa3c4c2-baa2-4f45-a5b9-7c73a8eaffb1'}
